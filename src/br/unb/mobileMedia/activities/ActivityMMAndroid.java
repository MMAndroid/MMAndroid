...
@SuppressLint("NewApi")
public class ActivityMMAndroid extends FragmentActivity implements Observer {
	...
	private class SyncAudios extends AsyncTask<String, Integer, String> {
		...
		protected String doInBackground(String... parameters) {
			try {
				...
				return ActivityMMAndroid.this.getString(R.string.sync_music);
			} catch (DBException e) {
				Log.i("Exception", e.getCause().toString());
				e.getStackTrace();
				return ActivityMMAndroid.this.getString(R.string.sync_music_not_ok);
			}
		}
		...
		protected void onPostExecute(String result) {
			...
			SingleToast.show(ActivityMMAndroid.this, result, Toast.LENGTH_LONG);
