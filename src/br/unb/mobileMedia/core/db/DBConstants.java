...
//	public int DATABASE_VERSION = 24;
	...
	public String SELECT_AUTHORS = "SELECT _ID, NAME FROM AUTHOR";
	public String SELECT_AUTHORS_BY_ID = "SELECT _ID, NAME FROM AUTHOR WHERE _ID = ?";
	public String SELECT_AUTHORS_BY_NAME = "SELECT _ID, NAME FROM AUTHOR WHERE NAME = ?";
	
	public String SELECT_ALBUMS_BY_AUTHOR = "SELECT _ID, NAME, IMAGE, AUTHOR_ID FROM ALBUM WHERE AUTHOR_ID = ?";
	public String SELECT_ALBUMS_BY_NAME = "SELECT _ID, NAME, IMAGE, AUTHOR_ID FROM ALBUM WHERE NAME = ?";
	...
	public String SELECT_AUDIO_BY_ALBUM = "SELECT _ID, TITLE, URL, ALBUM_ID FROM AUDIO WHERE ALBUM_ID = ?";
	
	public String SELECT_AUDIO_BY_PATH = "SELECT URL FROM AUDIO WHERE URL = ?";
