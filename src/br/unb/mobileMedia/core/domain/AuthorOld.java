 ...
 * @author rbonifacio
 */
public class AuthorOld implements MultimediaRelated {
	...
	public AuthorOld(Integer id, String name) {
		this(name);
		this.id = id;
	}
	
	public AuthorOld(String name) {
		this.name = name;
	}
	...
	public boolean equals(Object o) {
		return (o instanceof AuthorOld) && ((AuthorOld)o).getKey().equals(this.getKey());
	}
